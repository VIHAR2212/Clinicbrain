    ...
    const addScript = () => {
      ...
      window.googleTranslateElementInit = function () {
        new window.google.translate.TranslateElement(
          { pageLanguage: 'en', includedLanguages: 'en,hi,mr', layout: 0, autoDisplay: false },
          ...
          {mobileOpen && (
            ...
            >
              <div className="px-4 py-4 space-y-1">
                ...
                <Link to="/#book" onClick={() => setMobileOpen(false)} className="btn-primary w-full justify-center text-xs mt-1">
                  {t(lang, 'book_now')}
                </Link>
              </div>
            </motion.div>
